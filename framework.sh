...
info() {
  ...
  output=${output/ $(function_name)/ $(raw_foreground "$INFO_FOREGROUND_COLOR")$(raw_background "$INFO_BACKGROUND_COLOR")info$(raw_foreground none)}
...
warn() {
  ...
  output=${output//:/$(raw_foreground red):$(raw_foreground none)}
  output=${output/ $(function_name)/ $(raw_foreground "$WARN_FOREGROUND_COLOR")$(raw_background "$WARN_BACKGROUND_COLOR")warn$(raw_foreground none)}
  output="$(colorize "$output")"
  echo -e "$output"
}
...
error() {
  ...
  output=${output//:/$(raw_foreground red):$(raw_foreground none)}
  output=${output/ $(function_name)/ $(raw_foreground "$ERROR_FOREGROUND_COLOR")$(raw_background "$ERROR_BACKGROUND_COLOR")error$(raw_foreground none)}
  output="$(colorize "$output")"
  echo -e "$output"
}
...
user_info() {
  ...
  output=${output/__core_function_info: /}
  output=${output//:/$(raw_foreground red):$(raw_foreground none)}
  output=${output/$(function_name)/$(raw_foreground "$INFO_FOREGROUND_COLOR")$(raw_background "$INFO_BACKGROUND_COLOR")info$(raw_foreground none)}
  output="$(colorize "$output")"
  echo -e "$output"
...
user_warn() {
  ...
  output=${output/__core_function_warn: /}
  output=${output//:/$(raw_foreground red):$(raw_foreground none)}
  output=${output/$(function_name)/$(raw_foreground "$WARN_FOREGROUND_COLOR")$(raw_background "$WARN_BACKGROUND_COLOR")warn$(raw_foreground none)}
  output="$(colorize "$output")"
  echo -e "$output"
...
user_error() {
  ...
  output=${output/__core_function_error: /}
  output=${output//:/$(raw_foreground red):$(raw_foreground none)}
  output=${output/$(function_name)/$(raw_foreground "$ERROR_FOREGROUND_COLOR")$(raw_background "$ERROR_BACKGROUND_COLOR")error$(raw_foreground none)}
  output="$(colorize "$output")"
  echo -e "$output"
...
__core_load_default_colors() {
  INFO_FOREGROUND_COLOR="${INFO_FOREGROUND_COLOR:-white}"
  WARN_FOREGROUND_COLOR="${WARN_FOREGROUND_COLOR:-white}"
  ERROR_FOREGROUND_COLOR="${ERROR_FOREGROUND_COLOR:-white}"

  INFO_BACKGROUND_COLOR="${INFO_BACKGROUND_COLOR:-green}"
  WARN_BACKGROUND_COLOR="${WARN_BACKGROUND_COLOR:-yellow}"
  ERROR_BACKGROUND_COLOR="${ERROR_BACKGROUND_COLOR:-red}"
}
